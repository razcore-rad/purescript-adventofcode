...
pFromRegex s = either (const false) identity <<< fromRegex s <<< pure
  where fromRegex :: String -> Either String String -> Either String Boolean
        fromRegex = apply <<< map test <<< flip regex ignoreCase

p3OrMoreVowls :: String -> Boolean
p3OrMoreVowls = pFromRegex """(?:[b-df-hj-np-tv-z]*[aeiou]){3,}"""

pLetterTwiceInRow :: String -> Boolean
pLetterTwiceInRow = pFromRegex """([a-z])\1"""

pNotThem :: String -> Boolean
...
pNonOverlappingPairs = pFromRegex """(..).*\1"""
